...
variant(extended) :- true. % Set to true/fail if you want to use channeling between dual models
...
setup_model(channeling, Puzzle, N, K, flatten(Puzzle)) :-
    ...
    generate_constraints_channeling(Variables, PuzzleArray, N, K).
...
% @param N      The dimension of the puzzle.
% @param K      The dimension of blocks.
generate_constraints_channeling(Variables, Puzzle, N, K) :-
