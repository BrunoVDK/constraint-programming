...
Three challenges were addressed in this report. For each of these, a solver was implemented in at least one language. The solvers could be improved further by enforcing bound consistency for sum constraints (in the case of \texttt{CHR} solvers) and by experimenting more with redundant constraints or even some custom-made heuristics. Generally, however, satisfactory results were obtained. Some of the experiments underline the importance of active (instead of passive) constraints, the value of simplicity and the usefulness of introducing redundancy.
